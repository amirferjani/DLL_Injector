const CACHE='registratiekassa-zoo-v15';
...
self.addEventListener('fetch',event=>{
  ...
  const networkFirst=event.request.mode==='navigate'||/\/(?:index\.html|loader\.js|sw\.js|apple-fixes\.css|voice-controller\.js)$/.test(url.pathname);
  if(networkFirst){
