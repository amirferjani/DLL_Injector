const CACHE='registratiekassa-zoo-v10';
const APP_PARTS=Array.from({length:8},(_,index)=>`./assets/app.full.${String(index+1).padStart(2,'0')}.b64`);
const FILES=['./','./index.html','./loader.js','./manifest.webmanifest','./icons/icon.svg','./assets/styles.v4.gz.b64',...APP_PARTS];
