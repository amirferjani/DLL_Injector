const CACHE='registratiekassa-zoo-v21-fonts-only';
...
self.addEventListener('fetch',event=>{
  ...
  const networkFirst=event.request.mode==='navigate'||/\/(?:index\.html|loader\.js|sw\.js|apple-fixes\.css|voice-controller\.js|boss-audit\.css|boss-audit\.js|order-history-addon\.js|interaction-upgrades\.css|order-controls\.js|connection-manager\.js)$/.test(url.pathname);
  if(networkFirst){
